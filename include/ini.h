...
public:
	...
	/**
	 * Return name of ini setting - Use Php::ini_get_orig() to get MASTER VALUE and send this method's return value as parameter or Php::ini_get() to LOCAL VALUE and send this method's return value as parameter 
	 * @return string
	 */ 
    std::string name() {
        return _name;
